...
const Crop2 = (props: ICrop2Prop) => {
  ...
  useEffect(() => {
    if (!isInitialized.current && !isInitializing.current) {
      ...
      if (!_.isEqual(prevClipBound.current, curClipBound)) {
        console.log("prevClipBound", prevClipBound.current, curClipBound);
        prevClipBound.current = curClipBound;
        setTimeout(() => {
          sendNewClipBound(curClipBound);
        }, 0);
      }
    }
